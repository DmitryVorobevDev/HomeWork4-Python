...
my_list1 = set([int(input("Введите число для списка 1: ")) for i in range(n)])
my_list2 = set([int(input("Введите число для списка 2: ")) for i in range(m)])


print (*list(sorted(my_list1 & my_list2)) if len(my_list1 & my_list2) !=0 else 'Повторяющихся чисел нет')
